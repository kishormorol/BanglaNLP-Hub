...
[![Datasets](https://img.shields.io/badge/datasets-55-7c3aed)](./data/datasets)
[![Papers](https://img.shields.io/badge/papers-706-2563eb)](./data/papers)
...
The catalog currently holds **706 papers**, **55 datasets**, **25 models**, and **9 tools** across **12 tasks** — the paper count roughly tripled in July 2026 through hand-verified sweeps of the ACL Anthology, arXiv, and OpenAlex journal articles (see [`TODO-data.md`](./TODO-data.md)).
...
Known gaps are tracked openly in [`TODO-data.md`](./TODO-data.md) rather than quietly papered over: 49 datasets lack BibTeX and ten of the eleven leaderboards await rows.
...
- **BibTeX.** 49 datasets have no citation entry. Copy the published one from the ACL Anthology or the publisher page — please do not hand-write one.
