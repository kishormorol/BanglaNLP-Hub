...
[![Datasets](https://img.shields.io/badge/datasets-49-7c3aed)](./data/datasets)
[![Papers](https://img.shields.io/badge/papers-700-2563eb)](./data/papers)
[![Models](https://img.shields.io/badge/models-25-0891b2)](./data/models)
...
The catalog currently holds **700 papers**, **49 datasets**, **25 models**, and **9 tools** across **12 tasks** — the paper count roughly tripled in July 2026 through hand-verified sweeps of the ACL Anthology, arXiv, and OpenAlex journal articles (see [`TODO-data.md`](./TODO-data.md)).
...
Known gaps are tracked openly in [`TODO-data.md`](./TODO-data.md) rather than quietly papered over: 43 datasets lack BibTeX and ten of the eleven leaderboards await rows.
...
- **Reviewing paper tasks.** Most of the 700 papers were bulk-imported (ACL Anthology, arXiv, and hand-verified OpenAlex journal articles); their metadata is authoritative but each one's *task* was assigned by a title heuristic. Spotting a paper filed under the wrong task and moving it is a quick, high-value fix.
...
- **BibTeX.** 43 datasets have no citation entry. Copy the published one from the ACL Anthology or the publisher page — please do not hand-write one.
