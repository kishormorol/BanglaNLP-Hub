...
- **Reviewing paper tasks.** Most of the 437 papers were bulk-imported (ACL Anthology + arXiv); their metadata is authoritative but each one's *task* was assigned by a title heuristic. Spotting a paper filed under the wrong task and moving it is a quick, high-value fix.
